...
use App\Http\Controllers\Auth\RegisterDonaturController;
...
Route::middleware('guest')->group(function () {
    Route::get('register', [RegisterRoleController::class, 'create'])
        ->name('register');
    ...
    Route::get('register/donatur', [RegisterDonaturController::class, 'create'])
        ->name('register.donatur');

    Route::post('register/donatur', [RegisterDonaturController::class, 'store'])
        ->middleware('throttle:5,1')
